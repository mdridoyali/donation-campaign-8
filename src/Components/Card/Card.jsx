...
const Card = () => {
  ...
  return (
    <div className="">
      ...
      <div className="absolute inset-0 h-[90px]  top-[452px] w-[90vw] md:w-[82vw] mx-auto rounded-b-md bg-black opacity-40"></div>
        <img className="w-[90vw] h-[450px] mt-5 rounded-xl " src={showCard.image}  />
